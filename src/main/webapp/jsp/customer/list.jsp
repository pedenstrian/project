                        ...
                        <TD>
                            <TABLE id=grid
                                ...
                                <TR
                                    ...
                                    <TD>
                                    <a href="${pageContext.request.contextPath }/customer_update?cust_id=${customer.cust_id}">修改</a>
                                    &nbsp;&nbsp;
                              ...
                              <%--<s:iterator>
                                    <TR
                                        ...
                                        <TD>
                                            <a href="${pageContext.request.contextPath }/customer_update?cust_id=<s:property value="cust_id"/>">修改</a>
                                            &nbsp;&nbsp;
